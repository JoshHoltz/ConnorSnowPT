...
export const AdminMembershipTiers = () => {
  ...
  const handleSubmit = e => {
    ...
    fetch('https://www.connorsnowpt.com/api/insert-package-change', {
      method: 'POST',
      body: formData,
    })
      .then(res => {
      ...
      <div className="container mx-auto px-6 py-10 md:py-2">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {packages.map(pkg => (
            ...
            >
              <div className="border-t-4 bg-white p-8 shadow-lg flex flex-col h-full relative hover:bg-gray-200 transition duration-300 ease-in-out">
